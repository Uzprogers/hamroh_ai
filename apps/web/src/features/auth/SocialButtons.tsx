    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          onClick={() => startGoogle()}
          disabled={busy}
          className="btn-ghost h-12 px-3 text-sm"
        >
          <GoogleMark />
          Google
        </button>
        <button type="button" onClick={onTelegram} className="btn-ghost h-12 px-3 text-sm">
          <TelegramMark />
          Telegram
        </button>
      </div>
      ...
      <div className="flex items-center gap-3 pt-1 text-xs font-semibold uppercase tracking-wide text-muted">
